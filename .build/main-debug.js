// 所有模块都通过 define 来定义
define("main-debug", [ "jquery-debug", "jqueryCookie-debug", "FileSaver-debug", "jsXlsx-debug", "jsPDF-debug", "jsPDFAutoTable-debug", "html2canvas-debug", "tableExport-debug", "bootstrap-debug", "sweetalert2-debug", "es6Promise-debug", "notify-debug", "moment-debug", "momentZh-debug", "datetimepicker-debug", "select-debug", "bootstrapValidator-debug", "bootstrapValidatorZh-debug", "bootstrapTable-debug", "bootstrapTableExport-debug", "bootstrapTableEditable-debug", "bootstrapTableZh-debug", "bootstrapEditable-debug", "buttons-debug", "scrollbar-debug", "wizard-debug", "switch-debug", "iCheck-debug" ], function(require, exports, module) {
    // 通过 require 引入依赖
    var $ = require("jquery-debug");
    require("jqueryCookie-debug");
    require("FileSaver-debug");
    require("jsXlsx-debug");
    require("jsPDF-debug");
    require("jsPDFAutoTable-debug");
    require("html2canvas-debug");
    require("tableExport-debug");
    require("bootstrap-debug");
    require("sweetalert2-debug");
    require("es6Promise-debug");
    require("notify-debug");
    require("moment-debug");
    require("momentZh-debug");
    require("datetimepicker-debug");
    require("select-debug");
    require("bootstrapValidator-debug");
    require("bootstrapValidatorZh-debug");
    require("bootstrapTable-debug");
    require("bootstrapTableExport-debug");
    require("bootstrapTableEditable-debug");
    require("bootstrapTableZh-debug");
    require("bootstrapEditable-debug");
    require("buttons-debug");
    require("scrollbar-debug");
    require("wizard-debug");
       ...
       */
        ...
        renderData: function() {
            ...
            function contentText() {
                return [ '<ul class="popo-list">', '<li><a href="#profile">My Profile</a></li>', '<li><a href="#editprofile">Edit Profile</a></li>', '<li><a href="#settings">Settings</a></li>', "</ul>" ].join("");
            }
