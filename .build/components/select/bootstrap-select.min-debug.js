 ...
 */
!function(a, b) {
    "function" == typeof define && define.amd ? define("components/select/bootstrap-select.min-debug", [ "jquery-debug" ], function(a) {
        return b(a);
    }) : "object" == typeof module && module.exports ? module.exports = b(require("jquery-debug")) : b(a.jQuery);
}(this, function(a) {
    !function(a) {
        "use strict";
        function b(b) {
        ...
        var f = {
            ...
            "number" == typeof e && (this.options.windowPadding = [ e, e, e, e ]), this.val = k.prototype.val, 
            this.render = k.prototype.render, this.refresh = k.prototype.refresh, this.setStyle = k.prototype.setStyle, 
            this.selectAll = k.prototype.selectAll, this.deselectAll = k.prototype.deselectAll, 
            this.destroy = k.prototype.destroy, this.remove = k.prototype.remove, this.show = k.prototype.show, 
            this.hide = k.prototype.hide, this.init();
        };
        k.VERSION = "1.12.1", k.DEFAULTS = {
                    ...
                    if (g++, !f.hasClass("bs-title-option")) {
                        ...
                        if (f.data("content") || (m = p + '<span class="text">' + m + o + "</span>"), r && f.data("divider") !== !0) {
                            ...
                            if (0 === f.index()) {
                                ...
                                w = y + '<span class="text">' + i(w) + x + "</span>", 0 !== b && d.length > 0 && (g++, 
                                d.push(h("", null, "divider", e + "div"))), g++, d.push(h(w, null, "dropdown-header" + v, e));
                            }
            ...
            render: function(b) {
                ...
                this.$button.attr("title", j(a.trim(f.replace(/<[^>]*>?/g, "")))), this.$button.children(".filter-option").html(f), 
                ...
                this.options.size !== !1) {
                    ...
                    if (y(), "auto" === this.options.size) {
                        var z = function() {
                            ...
                            e = k.width()), j.options.dropupAuto && j.$newElement.toggleClass("dropup", f > g && b - w.vert < d), 
                            j.$newElement.hasClass("dropup") && (b = f - w.vert), "auto" === j.options.dropdownAlignRight && k.toggleClass("dropdown-menu-right", h > i && c - w.horiz < e - o), 
                        ...
                        d = k.data("height")) : d = k.height(), j.options.dropupAuto && this.$newElement.toggleClass("dropup", f > g && b - w.vert < d), 
                        k.css({
            ...
            liveSearchListener: function() {
                ...
                this.$button.on("click.dropdown.data-api", function() {
                    ...
                    d.remove(), c.$searchbox.val()) {
                        ...
                        e.length === f.length) d.html(c.options.noneResultsText.replace("{0}", '"' + i(c.$searchbox.val()) + '"')), 
            ...
            keydown: function(c) {
                ...
                d = a('[role="listbox"] li', n), l = o.$newElement.hasClass("open"), !l && (c.keyCode >= 48 && c.keyCode <= 57 || c.keyCode >= 96 && c.keyCode <= 105 || c.keyCode >= 65 && c.keyCode <= 90)) return o.options.container ? o.$button.trigger("click") : (o.setSize(), 
                o.$menu.parent().addClass("open"), l = !0), void o.$searchbox.focus();
                if (o.options.liveSearch && (/(^9$|27)/.test(c.keyCode.toString(10)) && l && (c.preventDefault(), 
                c.stopPropagation(), o.$menuInner.click(), o.$button.focus()), d = a('[role="listbox"] li' + p, n), 
                ...
                d.length) {
                    ...
                    e != j && e > i && (e = i), e < g && (e = g), e == k && (e = h)) : 40 == c.keyCode && (o.options.liveSearch && e++, 
