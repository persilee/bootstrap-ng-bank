...
!function(t) {
    "function" == typeof define && define.amd ? define("components/bootstrap-notify/bootstrap-notify.min-debug", [ "jquery-debug" ], t) : t("object" == typeof exports ? require("jquery-debug") : jQuery);
}(function(t) {
    function e(e, i, n) {
        var i = {
            content: {
        ...
        n = t.extend(!0, {}, i, n), this.settings = t.extend(!0, {}, s, n), this._defaults = s, 
    ...
    String.format = function() {
                ...
                update: function(e, s) {
                    ...
                    for (var e in i) switch (e) {
                      case "type":
                        ...
                        t.settings.type = i[e], this.$ele.addClass("alert-" + i[e]).find('[data-notify="progressbar"] > .progress-bar').addClass("progress-bar-" + i[e]);
                        break;
        ...
        placement: function() {
            ...
            }), 1 == this.settings.newest_on_top && (s = this.settings.offset.y), i[this.settings.placement.from] = s + "px", 
            ...
            }), t(this.settings.element).append(this.$ele), 1 == this.settings.newest_on_top && (s = parseInt(s) + parseInt(this.settings.spacing) + this.$ele.outerHeight(), 
            this.reposition(s)), t.isFunction(e.settings.onShow) && e.settings.onShow.call(this.$ele), 
        ...
        close: function() {
            ...
            this.$ele.data("closing", "true").addClass(this.settings.animate.exit), e.reposition(s), 
            t.isFunction(e.settings.onClose) && e.settings.onClose.call(this.$ele), this.$ele.one(this.animations.start, function() {
                i = !0;
            }).one(this.animations.end, function() {
